 ...
 *
 * Only fields the in-browser page editor accepts may appear here. It validates frontmatter
 * against a fixed allowlist (id, title, description, tags, category, date, order,
 * background) and refuses to save a page carrying anything else, so a `generated:` key
 * would quietly make every block page uneditable. The generated-ness marker is therefore
 * the HTML comment below, which is the first thing an editor sees in the raw markdown.
 */
