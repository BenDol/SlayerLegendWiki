---
id: index
title: Getting Started with Slayer Legend
description: New to Slayer Legend? Start here - what the game is, how to install it, your first hour, the core mechanics, and a roadmap through the early game.
tags: [beginner, tutorial, getting-started, new-player]
category: Getting Started
date: 2026-08-16
---

# <span class="text-gray-900 dark:text-gray-100">Welcome, Slayer</span>

Slayer Legend is a pixel-art idle RPG by GEAR2 where you grow a single sword-swinging character from a nobody in the Beginning Forest into something that one-shots screen-fulls of monsters across 2,000 stages. The core loop is simple - your Slayer fights on their own, you spend what they earn to make them stronger - but underneath that simple loop sits a surprisingly deep stack of systems: promotions, classes, skills, spirits, companions, soul weapons, and more. This section gets you through the front door without wasting your early resources.
...
- **[Your First Steps](/getting-started/first-steps)** - the first hour: guide quests, spending gold, learning your first skills, and your first promotion battles.
- **[Core Mechanics](/getting-started/core-mechanics)** - how combat, stats, elements, mana, and idle rewards actually work under the hood.
- **[UI Guide](/getting-started/ui-guide)** - a tour of every menu and tab so nothing on the screen is a mystery.
- **[Early Game Roadmap](/getting-started/early-game-roadmap)** - milestone-by-milestone guidance from stage 1 up to the Ether promotion (~stage 340), where the mid game begins.

# <span class="text-gray-900 dark:text-gray-100">Where to Go Next</span>

Once you have your footing, the rest of the wiki goes deep on every system:

- [Character](/character) - stats, promotions, classes, latent power, and the training diary.
