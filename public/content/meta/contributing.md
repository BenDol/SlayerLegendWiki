...
If you want to help but aren't sure where to start: verified numbers from your own gameplay (drop rates, costs, promotion battle experiences), screenshots of newer content, corrections after game updates, and build write-ups for the [tools](/tools) pages are consistently the most valuable contributions. Small fixes count too - a corrected typo or an updated stat is a genuinely useful edit.
