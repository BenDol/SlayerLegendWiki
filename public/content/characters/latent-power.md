...
**This content is unlocked after obtaining your first <img src="/images/items/ui_item_DragonForce.png" alt="" class="inline-image" style="display: inline-block; vertical-align: middle;width: 25px; height: 25px; margin: -2px 0 0 0;" data-inline="true" /><span class="text-cyan-600 dark:text-cyan-400">Dragon Power</span> from the Ancient Dragon in the Shelter of Sleeping Flame and can then be used to enhance your stats. Stats can be increased up to a maximum level of 50 using this.**


| <div style="text-align: center;"><img src="/images/altar/DragonStat 1.png" alt="" class="inline-image" style="display: inline-block; vertical-align: middle; width: 49px; height: 51px; margin: 0 0.25em;" data-inline="true" /></div> | <div style="text-align: center;"><img src="/images/altar/DragonStat 2.png" alt="" class="inline-image" style="display: inline-block; vertical-align: middle; width: 49px; height: 51px; margin: 0 0.25em;" data-inline="true" /></div> | <div style="text-align: center;"><img src="/images/altar/DragonStat 3.png" alt="" class="inline-image" style="display: inline-block; vertical-align: middle; width: 49px; height: 51px; margin: 0 0.25em;" data-inline="true" /></div> | <div style="text-align: center;"><img src="/images/altar/DragonStat 4.png" alt="" class="inline-image" style="display: inline-block; vertical-align: middle; width: 49px; height: 51px; margin: 0 0.25em;" data-inline="true" /></div> | <div style="text-align: center;"><img src="/images/altar/DragonStat 5.png" alt="" class="inline-image" style="display: inline-block; vertical-align: middle; width: 49px; height: 51px; margin: 0 0.25em;" data-inline="true" /></div> |
|----------|----------|----------|----------|----------|
...
**There are five pages of stats that can be upgraded using <img src="/images/items/ui_item_DragonForce.png" alt="" class="inline-image" style="display: inline-block; vertical-align: middle;width: 25px; height: 25px; margin: -2px 0 0 0;" data-inline="true" /><span class="text-cyan-600 dark:text-cyan-400">Dragon Power</span>. Each stat can be upgraded up to 10 times on each page and upgrades are randomly assigned when <img src="/images/items/ui_item_DragonForce.png" alt="" class="inline-image" style="display: inline-block; vertical-align: middle;width: 25px; height: 25px; margin: -2px 0 0 0" data-inline="true" /><span class="text-cyan-600 dark:text-cyan-400">Dragon Power</span> is consumed.**
